...
<div class="card">
    <div class="card-header">
        <h2 class="float-left">Cadastro de Produtos</h2>
    ...
    <div class="card-body">
        <form name="formProdutos" method="post" action="salvar/produtos" enctype="multipart/form-data" data-parsley-validate="">
            <label for="id">ID:</label>
            <input type="text" name="id" id="id" readonly class="form-control" value="<?=$id?>">
            <br>
            <label for="nome">Nome do Produto:</label>
            <input type="text" name="nome" id="nome" required data-parsley-validate="Por favor preencha este campo" 
            ...
            <input type="text" name="valor" id="valor" required data-parsley-required-message="Preencha o valor"
                class="form-control valor" value="<?=$valor?>">
            <label for="descricao">Descrição do Produto: </label>
            <textarea name="descricao" id="descricao" rows="5" required 
                data-parsley-required-message="Preencha a descrição do produto" 
                    class="form-control texto"><?=$descricao?></textarea>
            ...
            <?php
                if (!empty($imagem1)) {
                    ?>
                    <img src="../produtos/<?=$imagem1?>" width="200px"><br>
                    <?php
                }
            ?>
            ...
            <?php
                if (!empty($imagem2)) {
                    ?>
                    <img src="../produtos/<?=$imagem2?>" width="200px"><br>
                    <?php
                }
            ?>
